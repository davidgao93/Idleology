    ...
    with open(filename, "w") as file:
        for image in images:
            ...
            name = (
                image["name"]
                if image["name"]
                else (image["title"] if image["title"] else "No Name")
            )
...
def main():
    album_id = "NnBBx9f"  # Replace with the Imgur album ID
    access_token = (
        "13767a4ef279ce38ecf274e0a99b065390fdc4f6"  # Replace with your access token
    )
