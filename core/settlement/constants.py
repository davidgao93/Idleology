...
BUILDING_INFO = {
    ...
    "war_camp": "Passive generator: Produces Combat Stamina — **~10 Stamina per 24h per 100 Workers**. Collected via the Collect button. Stamina is capped at 10 and never exceeds the normal maximum.",
}
