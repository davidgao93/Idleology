...
WRITS: dict[str, WritDef] = {
    "unyielding_guardian": WritDef(
        "unyielding_guardian", "Unyielding Guardian",
        "Aphrodite Reborn has 30% Damage Reduction", 10,
    ),
    "wrathful_reckoner": WritDef(
        "wrathful_reckoner", "Wrathful Reckoner",
        "Lucifer Reborn deals 30% increased damage", 10,
    ),
    "devouts_burden": WritDef(
        "devouts_burden", "Devout's Burden",
        "The Arbiter presents 1 fewer respite option", 20,
    ),
    "fracture_of_balance": WritDef(
        "fracture_of_balance", "Fracture of Balance",
        "Gemini Reborn: true damage portion increases from 80% to 90%", 80,
    ),
    "hungering_void": WritDef(
        "hungering_void", "Hungering Void",
        "NEET Reborn: void drain increases from 1.5% to 3.0% per round", 80,
    ),
    "abyssal_embrace": WritDef(
        "abyssal_embrace", "Abyssal Embrace",
        "Evelynn Reborn: Delirious difficulty instead of Nightmarish", 150,
    ),
    "devotions_walk": WritDef(
        "devotions_walk", "Devotion's Walk",
        "Finish the entire run in under 400 total turns", 50, group="speed",
    ),
    "devotions_run": WritDef(
        "devotions_run", "Devotion's Run",
        "Finish the entire run in under 300 total turns", 100, group="speed",
    ),
    "devotions_sprint": WritDef(
        "devotions_sprint", "Devotion's Sprint",
        "Finish the entire run in under 200 total turns", 150, group="speed",
    ),
    "trials_drought": WritDef(
        "trials_drought", "Trial's Drought",
        "Cannot use potions at any point during the run", 200,
    ),
    "trials_fury": WritDef(
        "trials_fury", "Trial's Fury",
        "All boss base damage is doubled", 200,
    ),
    "one_last_chance": WritDef(
        "one_last_chance", "One Last Chance",
        "Run begins with 2 attempts instead of 3", 100, group="attempts",
    ),
    "no_mercy": WritDef(
        "no_mercy", "No Mercy",
        "Run begins with 1 attempt", 250, group="attempts",
    ),
}
