...
_WEAPON_PASSIVE_DESC: dict[str, str] = {
    ...
    "poison_1": "Misses deals up to 8% of ATK",
    "poison_2": "Misses deals up to 16% of ATK",
    "poison_3": "Misses deals up to 24% of ATK",
    "poison_4": "Misses deals up to 32% of ATK",
    "poison_5": "Misses deals up to 40% of ATK",
    ...
    "shocking_1": "Hit Dmg is at least 8% of ATK",
    "shocking_2": "Hit Dmg is at least 16% of ATK",
    "shocking_3": "Hit Dmg is at least 24% of ATK",
    "shocking_4": "Hit Dmg is at least 32% of ATK",
    "shocking_5": "Hit Dmg is at least 40% of ATK",
    ...
    "cull_1": "Attempts to cull if enemy HP < 8%",
    "cull_2": "Attempts to cull if enemy HP < 16%",
    "cull_3": "Attempts to cull if enemy HP < 24%",
    "cull_4": "Attempts to cull if enemy HP < 32%",
    "cull_5": "Attempts to cull if enemy HP < 40%",
    # Deadeye family — Hit chance (+4 flat per tier)
    "deadeye_1": "Hit Chance +4",
    "deadeye_2": "Hit Chance +8",
    "deadeye_3": "Hit Chance +12",
    "deadeye_4": "Hit Chance +16",
    "deadeye_5": "Hit Chance +20",
    # Echo family — Extra hit damage (×10% per tier)
    "echo_1": "Extra hit dealing 10% Dmg on non-crits",
    "echo_2": "Extra hit dealing 20% Dmg on non-crits",
    "echo_3": "Extra hit dealing 30% Dmg on non-crits",
    "echo_4": "Extra hit dealing 40% Dmg on non-crits",
    "echo_5": "Extra hit dealing 50% Dmg on non-crits",
    # Arcane family — Ward on hit (+25 per tier)
    "arcane_1": "Gain 25 Ward on hits and crits",
    "arcane_2": "Gain 50 Ward on hit and crits",
    "arcane_3": "Gain 75 Ward on hit and crits",
    "arcane_4": "Gain 100 Ward on hit and crits",
    "arcane_5": "Gain 125 Ward on hit and crits",
}
...
_INFERNAL_PASSIVE_DESC: dict[str, str] = {
    ...
    "cursed precision": "Crit Chance +20%; your critical damage is unlucky",
    "diabolic pact": "Combat Start: Take 90% max HP as True Damage and double ATK",
    "perdition": "On miss: Deal 75% of weapon ATK",
    "voracious": "On hit: Gain a stack of Voracity; Each stack gives +5% Crit Chance. Lose stacks on crit.",
...
_ARMOR_PASSIVE_DESC: dict[str, str] = {
    ...
    "piety": "Attacks have a 10% chance to deal 700% increased damage",
...
_VOID_PASSIVE_DESC: dict[str, str] = {
    ...
    "unravelling": "At combat start, reduce monster DEF by 20%",
...
_HELMET_PASSIVE_FUNCS: dict = {
    ...
    "leeching": lambda l: f"Heal {l * 0.02:.2f}% of damage dealt",
