...
from core.combat.mobgen.gen_mob import calculate_monster_stats, get_modifier_description
...
class DummyConfigView(BaseView):
    ...
    def update_components(self):
        ...
        btn_exit = ui.Button(label="Close", style=ButtonStyle.secondary, row=3)
    ...
    async def run_sim(self, interaction: Interaction):
        ...
        from core.combat.mobgen.gen_mob import _apply_spawn_modifiers
