...
class Partner:
    ...
    @classmethod
    def from_row(cls, row, static: dict) -> "Partner":
        return cls(
            row_id=row["id"],
            user_id=row["user_id"],
            ...
            level=row["level"],
            exp=row["exp"],
            combat_slot_1=row["combat_slot_1"],
            combat_slot_1_lvl=row["combat_slot_1_lvl"],
            combat_slot_2=row["combat_slot_2"],
            combat_slot_2_lvl=row["combat_slot_2_lvl"],
            combat_slot_3=row["combat_slot_3"],
            combat_slot_3_lvl=row["combat_slot_3_lvl"],
            sig_combat_lvl=row["sig_combat_lvl"],
            dispatch_slot_1=row["dispatch_slot_1"],
            dispatch_slot_1_lvl=row["dispatch_slot_1_lvl"],
            dispatch_slot_2=row["dispatch_slot_2"],
            dispatch_slot_2_lvl=row["dispatch_slot_2_lvl"],
            dispatch_slot_3=row["dispatch_slot_3"],
            dispatch_slot_3_lvl=row["dispatch_slot_3_lvl"],
            sig_dispatch_lvl=row["sig_dispatch_lvl"],
            dispatch_task=row["dispatch_task"],
            dispatch_start_time=row["dispatch_start_time"],
            dispatch_task_2=row["dispatch_task_2"],
            dispatch_start_time_2=row["dispatch_start_time_2"],
            is_active_combat=bool(row["is_active_combat"]),
            is_dispatched=bool(row["is_dispatched"]),
            affinity_encounters=row["affinity_encounters"],
            affinity_story_seen=row["affinity_story_seen"],
            portrait_variant=row["portrait_variant"],
            name=static["name"],
            title=static["title"],
