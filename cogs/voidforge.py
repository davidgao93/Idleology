...
class Voidforge(commands.Cog, name="voidforge"):
    def __init__(self, bot) -> None:
        self.bot = bot

    @app_commands.command(name="voidforge", description="View your character's weapons and modify them.")
...
async def setup(bot) -> None:
    await bot.add_cog(Voidforge(bot))