...
class General(commands.Cog, name="general"):
    ...
    async def mod_details(
        ...
        if category == "monster":
            ...
            embed.description = (
                "**Vitality** — +% Max HP\n"
                "**Wrath** — +% of flat DEF as bonus ATK\n"
                "**Bastion** — +% of flat ATK as bonus DEF\n"
                "**Tenacity** — Chance to halve damage taken\n"
                "**Bloodthirst** — Heal % of critical damage dealt\n"
                "**Providence** — +% more rarity\n"
                "**Insight** — + crit chance\n"
                "**Affluence** — +% XP and Gold\n"
            ...
            embed.description = (
                ...
                "**Joint Attack** — On hit: % chance to attack alongside you. "
                "Damage is flat based on partner ATK, unaffected by multipliers.\n"
                "**Heal** — During Combat: Heals you for % max HP every 3 turns.\n"
                "**Damage Reduction** — During Combat: % chance to reduce damage taken by 50% per hit.\n"
                "**Stat Transfer** — Combat start: adds % of partner ATK/DEF/HP as bonus stats.\n"
                "**Monster Debuff** — Combat start: reduces monster ATK and DEF by %.\n"
                "**XP Boost** — On victory: +% XP.\n"
                "**Gold Boost** — On victory: +% gold.\n"
                "**Special Find** — On victory: +% special rarity.\n"
                "**ATK from DEF** — Combat start: Gain % of partner DEF as bonus ATK.\n"
                "**DEF from ATK** — Combat start: Gain % of partner ATK as bonus DEF.\n"
                "**Curse: Weaken** — Combat start: reduces monster ATK by %.\n"
                "**Curse: Expose** — Monster takes % more damage.\n"
                "**— Rare Combat Skills —**\n"
                "**Crit Rate** — On active: + Crit chance.\n"
                "**Crit Damage** — On active: + Critical strike multiplier.\n"
                "**Execute** — During combat: Culls the monster at % HP. Does NOT stack with other cull sources.\n"
                "**Ward Regen** — During combat: Generates ward per turn.\n"
                "**Ward Leech** — On hit: % of damage dealt is gained as ward.\n"
                "**— Combat Signatures —**\n"
                "**Skol | Essence Communion** — Combat start: Gain N random corrupted essence buffs."
                "Buffs are not granted for essence types the player already equipped.\n"
                "**Eve | Final Stand** — During combat: When HP would drop to 0, survive by consuming potions and restore HP to full.\n"
                "**Kay | Windfall** — On victory: % chance to obtain an extra curio after each /combat only.\n"
                "**Sigmund | Decisive Strike** — On hit: % chance to deal 100% increased damage.\n"
                ...
                "Formula: (gold ÷ 1,000) × skill yield.\n"
                "**Yvenn | Apex Hunter** — All monsters count as slayer task monsters; "
                "grants bonus slayer progress per kill."
            )
            content_added = True
    ...
    async def help(self, interaction: discord.Interaction) -> None:
        ...
        categories = {
            ...
            "⚔️ Combat": [
                ...
                ("inner_sanctum", "Permanent combat mastery tree (Lvl 25+)"),
                ...
                ("artefact", "View your equipped Rite Artefact"),
            ],
            "🎒 Equipment & Loot": [
            ...
            "🏙️ Social & Economy": [
                ...
                ("hallofirsts", "See who was first to claim each server-wide legend"),
                ...
                ("black_market", "Open your settlement's Black Market (Lvl 50+)"),
